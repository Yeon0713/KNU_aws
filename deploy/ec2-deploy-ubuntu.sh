...
# KNU 건강 관리 앱 EC2 배포 스크립트 (Ubuntu용)

echo "🚀 KNU 건강 관리 앱 EC2 배포 시작 (Ubuntu)..."
...
echo "🐍 Python 3.11 및 필수 패키지 설치 중..."
...
Type=simple
User=ubuntu
WorkingDirectory=/home/ubuntu/KNU_aws/senior_supplement/backend
